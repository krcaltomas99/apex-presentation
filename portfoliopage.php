		...
		<div class="container">
			...
			<div class="row mb-5">
				...
				<div class="col-12 col-md-7">
					<img class="img-fluid" src="assets/images/portfolio/portfolio.jpg" alt="">
				</div>
			</div>
			...
			<div class="row">
				...
				<div>
					<img src="assets/images/portfolio/portfolio2.jpg" alt="" class="img-fluid">
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 py-5">
						<h3 class="font-weight-bold text-center mb-5">Galerie fotek našeho nového studia</h3>

						<div class="row">
							<div class="col-12 col-md-6 col-xl-4 mb-4">
								<a href="assets/images/portfolio/bg1.jpg" data-lightbox="studio">
									<img class="img-fluid" src="assets/images/portfolio/bg1.jpg" alt="">
								</a>
							</div>

							<div class="col-12 col-md-6 col-xl-4 mb-4">
								<a href="assets/images/portfolio/bg2.jpg" data-lightbox="studio">
									<img class="img-fluid" src="assets/images/portfolio/bg2.jpg" alt="">
								</a>
							</div>

							<div class="col-12 col-md-6 col-xl-4 mb-4">
								<a href="assets/images/portfolio/bg3.jpg" data-lightbox="studio">
									<img class="img-fluid" src="assets/images/portfolio/bg3.jpg" alt="">
								</a>
							</div>

							<div class="col-12 col-md-6 col-xl-4 mb-4">
								<a href="assets/images/portfolio/bg4.jpg" data-lightbox="studio">
									<img class="img-fluid" src="assets/images/portfolio/bg4.jpg" alt="">
								</a>
							</div>

							<div class="col-12 col-md-6 col-xl-4 mb-4">
								<a href="assets/images/portfolio/bg5.jpg" data-lightbox="studio">
									<img class="img-fluid" src="assets/images/portfolio/bg5.jpg" alt="">
								</a>
							</div>

							<div class="col-12 col-md-6 col-xl-4 mb-4">
								<a href="assets/images/portfolio/bg6.jpg" data-lightbox="studio">
									<img class="img-fluid" src="assets/images/portfolio/bg6.jpg" alt="">
								</a>
							</div>

							<div class="col-12 col-md-6 col-xl-4 mb-4">
								<a href="assets/images/portfolio/bg7.jpg" data-lightbox="studio">
									<img class="img-fluid" src="assets/images/portfolio/bg7.jpg" alt="">
								</a>
							</div>
						</div>
					</div>
